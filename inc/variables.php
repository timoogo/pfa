...
$randIndex = array_rand($arr_names, 2);
 
// output the value for the random index

 
 //  noms
 $random_name = array("$kyle", "$sm","$cartman","Kyle", "$kenny","$butters");
 
 //  random index de array $random_name
 $randIndex = array_rand($random_name,3 );
 
//essaye tableau

/*$dictionaire_fun_fact = array(
 'toto' => 'tata',
