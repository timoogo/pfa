...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.0/css/all.min.css"> <!--favicon -->
    ...
    <link rel="stylesheet" href="ressources/css/style.css"> <!-- page de css principale (?v=n permet -->

   
    <meta name="description" content="">
    <title>Projet d'axe : Cartman</title>
</head>